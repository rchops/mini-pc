...
void uart_init(){
    ...
    mmio_write(AUX_MU_LCR_REG, 3); // word length 8 bits
    mmio_write(AUX_MU_MCR_REG, 0);
    mmio_write(AUX_MU_IER_REG, 0);
    mmio_write(AUX_MU_IIR_REG, 0xC6); // gets rid of interrupts - 1100 0110 - enables FIFO, clears RX and TX, clears interrupt ID
